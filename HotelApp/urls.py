...
urlpatterns = [
    ...
    path('Author_ForgotPass', views.Author_ForgotPass, name='Author_ForgotPass'),
    ...
    path('CheckIn/<str:type>/<int:id>', views.CheckIn, name='CheckIn'),
    path('CheckOut/<str:type>/<int:id>', views.CheckOut, name='CheckOut'),
